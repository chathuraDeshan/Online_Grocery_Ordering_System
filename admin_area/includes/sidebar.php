...
<nav class="navbar navbar-inverse navbar-fixed-top"><!-- navbar navbar-inverse navbar-fixed-top begin -->
    ...
    <div class="collapse navbar-collapse navbar-ex1-collapse"><!-- collapse navbar-collapse navbar-ex1-collapse begin -->
        <ul class="nav navbar-nav side-nav"><!-- nav navbar-nav side-nav begin -->
            ...
            <li><!-- li begin -->
                <a href="#" data-toggle="collapse" data-target="#slidess"><!-- a href begin -->
                        
                        <i class="fa fa-fw fa-gear"></i> Order
                        <i class="fa fa-fw fa-caret-down"></i>
                        
                </a><!-- a href finish -->
                
                <ul id="slidess" class="collapse"><!-- collapse begin -->
                    <li><!-- li begin -->
                        <a href="index.php?view_orders"> View Order </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                         <a href="index.php?insert_status"> Insert Order Status </a>
                    </li><!-- li finish -->
                    <li><!-- li begin -->
                        <a href="index.php?view_order_status"> Change Status </a>
                    </li><!-- li finish -->
                </ul><!-- collapse finish -->
            ...
            <li><!-- li begin -->
                <a href="index.php?view_feedback"><!-- a href begin -->
                    <i class="fa fa-fw fa-gear"></i> Feedback
                </a><!-- a href finish -->
            </li><!-- li finish -->


            <li><!-- li begin -->
                <a href="index.php?view_inqury"><!-- a href begin -->
                    <i class="fa fa-fw fa-gear"></i> Inqury
                </a><!-- a href finish -->
            </li><!-- li finish -->
