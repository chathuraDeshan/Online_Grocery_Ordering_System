...
<head>
    ...
    <title>OGOS Admisitartion</title>
       ...
       <?php include("includes/sidebar.php"); ?>
        ...
        <div id="page-wrapper"><!-- #page-wrapper begin -->
            <div class="container-fluid"><!-- container-fluid begin -->
                ...
                } if(isset($_GET['view_order_status'])){
                        
                        include("view_order_status.php"); 
                ...
                } if(isset($_GET['view_inqury'])){
                        
                        include("view_inqury.php");

                }if(isset($_GET['delete_inqury'])){
                        
                        include("delete_inqury.php");
